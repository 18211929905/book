<template>
    <div class="halo-tree">
        ...
        <ul>
            <li>
                <div class="root">
                    <i class="icon iconfont" :class="[itemsShow ? treeNodeOptions.iconClass.open : treeNodeOptions.iconClass.close ]" :style="treeNodeOptions.iconStyle" @click="rootIconClick"></i>
                    <span @click="rootClick">{{ options.rootName }}</span>
                </div>
            </li>
        </ul>
        
        <tree-node :treeData='store.root' :options="treeNodeOptions" @handlecheckedChange="handlecheckedChange" v-show="itemsShow">
        </tree-node>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            rootClick() {
                this.$emit('root-click', this.treeRootCode, this.treeName, this.rootOrgCode)
            }
        },
        components: {
            TreeNode
