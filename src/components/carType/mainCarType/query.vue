                    ...
                    <form class="form-horizontal">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6" v-if="showFactory">
                                    <div class="form-group">
                                        <label class="control-label col-md-5 col-lg-4 col-sm-5">厂家:</label>
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList="factoryList" :option="facOptionName" @dataChange="facChange" @itemValue="facItemClick" @clearValue="facClearValue" @comScroll="facScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList="brandList" :option="braOptionName" @dataChange="braChange" @itemValue="braItemClick" @clearValue="braClearValue" @comScroll="braScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList="seriesList" :option="serOptionName" @dataChange="serChange" @itemValue="serItemClick" @clearValue="serClearValue" @comScroll="serScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList.sync="modelList" :option="modOptionName" @dataChange="modChange" @itemValue="modItemClick" @clearValue="modClearValue" @comScroll="modScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList.sync="opvList" :option="opvOptionName" @dataChange="opvChange" @itemValue="opvItemClick" @clearValue="opvClearValue" @comScroll="opvScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-lg-5 col-sm-6">
                                            <search :dataList.sync="ioTypeList" :option="ioOptionName" @dataChange="ioChange" @itemValue="ioItemClick" @clearValue="ioClearValue" @comScroll="ioScroll">
                                            </search>
                                        </div>
                                    </div>
                                </div>
                ...
                if (pageStart === 1) {
                    api.carType.ioType.getQueryInfo(_params).then((res) => {
                        ...
                        if (res.data.code === 'success'){
                            this.ioTypeList = res.data.obj.list;
                            this.ioIsLastPage = res.data.obj.isLastPage
                        }else{
                            console.log('#####mainCarType/query.vue => getIoTypeQueryInfo方法请求数据失败')
                        }
