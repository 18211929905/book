...
<input type="text" class="form-control" v-model="info.modelCode"/>
</div>
</div>
</div>
<div class="col-md-5 col-lg-5 col-sm-5">
...
<div class="col-md-7 col-lg-5 col-sm-6">
<input type="text" class="form-control" v-model="info.modelName"/>
</div>
</div>
</div>
...
<div class="col-md-7 col-lg-5 col-sm-6">
<input type="text" class="form-control" v-model="info.modelAddrName"/>
</div>
</div>
</div>
<div class="col-md-5 col-lg-5 col-sm-5">
